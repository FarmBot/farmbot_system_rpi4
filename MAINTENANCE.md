...
git clone https://github.com/farmbot/farmbot_system_rpi4
cd farmbot_system_rpi4
# ------- begin updates -------
git remote add upstream https://github.com/nerves-project/nerves_system_rpi4
git fetch --all
